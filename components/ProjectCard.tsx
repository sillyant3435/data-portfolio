...
export default function ProjectCard({ title, metrics, abstract }: ProjectCardProps) {
  return (
    <div className="w-[70vw] md:w-[45vw] lg:w-[35vw] h-[65vh] shrink-0 bg-[#0B0B0B] border border-white/10 rounded-3xl relative overflow-hidden group/card cursor-pointer">
      ...
      <div className="absolute right-0 top-0 p-8 opacity-20 transition-opacity duration-500 group-hover/card:opacity-40">
      ...
      <div className="absolute bottom-10 left-10 right-10 z-10 flex flex-col pointer-events-none">
        <span className="text-data text-datacyan text-sm mb-3 tracking-[0.2em] uppercase origin-left scale-75 md:scale-100">[{metrics}]</span>
